...
export default function EnquiryModal({ config, onClose }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[9999999] flex items-center justify-center overflow-y-auto bg-black/70 px-4 py-8"
      onMouseDown={(e) => {
        ...
        <form noValidate onSubmit={handleSubmit} className="space-y-5">
          ...
          {project ? (
            <p className="text-xs uppercase tracking-wide text-[#EDE8D0]/70">
              Project:{" "}
              <span className="font-semibold text-[#EDE8D0]">{project}</span>
            </p>
          ) : null}
